...
df_nba_finals_lineup |> 
    ggplot(aes(height_cm, y = 1)) +
    ggdist::geom_swarm(
        aes(fill = Team, group = 1), 
        shape = 21, color = "grey2", linewidth = 0.25, dotsize = 3, 
        alpha = 0.9
    ) +
    annotate(
        "richtext",
        x = brunson_height,
        y = 1,
        label = "<img src='media/brunson-circle.png' width=20>",
        vjust = 0.5,
        family = "Instrument Sans SemiBold",
        label.size = 0, fill = NA
    ) +
...
@cr-nba-finals In Game 5 of the 2026 NBA Finals, he was the shortest player in the Knicks and Spurs starting line-ups.<br><br>Yet, he turned out to be the most influential player of the deciding game.
